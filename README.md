...
Defender–receiver distance begins a sustained decrease, defined as shrinking for 4 consecutive frames (0.4 seconds at 10 Hz). The first frame in that run is labeled as the moment of reaction.
The defender’s acceleration along the defender‑to‑receiver line on that frame is above the 70th percentile of all such accelerations in the dataset.
